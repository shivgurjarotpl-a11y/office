...
const PortfolioCard1 = () => {
  ...
  useEffect(() => {
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            entry.target.classList.add("pc1-animate");
          }
        });
      },
    ...
    const els = document.querySelectorAll(
      ".pc1-hidden-left, .pc1-hidden-bottom, .pc1-hidden-right"
    );
  ...
  return (
    <div className="pc1-card" role="region" aria-label="Portfolio card - Fall detector">
      ...
      <div className="pc1-mobile" aria-hidden={false}>
        <div className="pc1-image pc1-hidden-bottom">
          {isIllustrationView ? (
            <img
        ...
        <div className="pc1-content pc1-hidden-right">
          <div className="mb-3">
          ...
          <div className="pc1-features">
            <div className="pc1-feature pc1-hidden-right">
      ...
      <div className="pc1-desktop" aria-hidden={false}>
        <div className="pc1-left pc1-hidden-bottom">
          {isIllustrationView ? (
            <img
              src="/image/fall-detector.png"
              alt="Stylized illustration of fall detector"
        ...
        <div className="pc1-right pc1-hidden-right">
          <div className="mb-4">
            <span className="pc1-badge">🚨 Fall Detector Device</span>
          </div>
