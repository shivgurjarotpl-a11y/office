...
const PortfolioCard2 = () => {
  ...
  return (
    <div className="pc1-card" role="region" aria-label="Portfolio card - Touch-less Temple Bell System">
      {/* Mobile Layout */}
      <div className="pc1-mobile" aria-hidden={false}>
        <div className="pc1-image">
           <img 
             src={isIllustrationView ? "/image/Gemini_Generated_Image_2.png" : "/image/Gemini_Generated_Image_2.png"} 
        ...
        <div className="pc1-content">
          <div className="mb-3">
            <span className="pc1-badge">🔔 Touch-less Temple Bell System</span>
          </div>

          <h3 className="pc1-title">A Modern Solution for Tradition</h3>
