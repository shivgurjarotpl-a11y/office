...
const PortfolioCard6 = () => {
  ...
  return (
    <div className="pc1-card" role="region" aria-label="Portfolio card - Light Dependent Smart Switch System">
      {/* Mobile Layout */}
      <div className="pc1-mobile" aria-hidden={false}>
        <div className="pc1-image">
          <img 
             src={isIllustrationView ? "/image/Gemini_Generated_Image_6.png" : "/image/Gemini_Generated_Image_6.png"} 
        ...
        <div className="pc1-content">
          <div className="mb-3">
            <span className="pc1-badge">💡 Light Dependent Smart Switch System</span>
          </div>

          <h3 className="pc1-title">Save Energy, Live Smart</h3>
