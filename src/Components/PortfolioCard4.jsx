...
const PortfolioCard4 = () => {
  ...
  return (
    <div className="pc1-card" role="region" aria-label="Portfolio card - Aerodynamic Wind Tunnel">
      {/* Mobile Layout */}
      <div className="pc1-mobile" aria-hidden={false}>
        <div className="pc1-image">
          <img 
             src={isIllustrationView ? "/image/Gemini_Generated_Image_4.png" : "/image/Gemini_Generated_Image_4.png"} 
        ...
        <div className="pc1-content">
          <div className="mb-3">
            <span className="pc1-badge">🌬️ Aerodynamic Wind Tunnel</span>
          </div>

          <h3 className="pc1-title">Bringing Science to Life</h3>
