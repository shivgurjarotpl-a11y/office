...
const PortfolioCard7 = () => {
  ...
  return (
    <div className="pc1-card" role="region" aria-label="Portfolio card - IoT-based RFID Attendance System">
      {/* Mobile Layout */}
      <div className="pc1-mobile" aria-hidden={false}>
        <div className="pc1-image">
          <img 
             src={isIllustrationView ? "/image/Gemini_Generated_Image_7.png" : "/image/Gemini_Generated_Image_7.png"} 
        ...
        <div className="pc1-content">
          <div className="mb-3">
            <span className="pc1-badge">📡 IoT-based RFID Attendance System</span>
          </div>

          <h3 className="pc1-title">Smarter Attendance, Seamless Management</h3>
